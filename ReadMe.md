...
// This test requires that when a request is made to the class implementing the
// ICurrentDateTimeProvider interface, that a different value is returned.  This
